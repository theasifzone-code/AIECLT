// tailwind.config.js - ✅ FIXED (Dark Mode Enabled)
/** @type {import('tailwindcss').Config} */
export default {
  darkMode: 'class', // ✅ Add this line - IMPORTANT!
  content: [
    "./index.html",
    "./src/**/*.{js,ts,jsx,tsx}",
  ],
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-mesh': 'url("/src/assets/mesh-gradient.svg")',
        'gradient-dots': 'url("/src/assets/dots-gradient.svg")',
      },
      ...
      boxShadow: {
        ...
        'glow-green': '0 0 40px rgba(34, 197, 94, 0.5)',
